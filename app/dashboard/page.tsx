    ...
    <>
      <div className={`min-h-screen p-4 sm:p-6 lg:p-8 ${isLight ? 'bg-light-bg' : 'bg-dark-bg'}`}>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className={`text-3xl font-bold mb-6 ${isLight ? 'text-light-textPrimary' : 'neon-blue'}`}>
            Visão Geral
          </h1>
        ...
        >
          <GlassCard className="p-6">
            <h2 className={`text-2xl font-semibold mb-6 ${isLight ? 'text-light-textPrimary' : 'text-dark-textPrimary neon-blue'}`}>
              Ações Rápidas
            </h2>
